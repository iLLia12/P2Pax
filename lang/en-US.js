export default {
  ...
  pages: {
    ...
    post_trade: {
      ...
      identify_user_before_continue_trade:
        "Identify user before continue trade",
      set_your_time:
        "Set your work time. If you uncheck the box, the corresponding day will be set as a holiday.",
      ...
      li: {
        ...
        b:
          "To be able to use certain payment methods, you need to pass an identity check. Only after that your ads will be visible",
        c:
          "If you did not find the payment system you are interested in, you can send the corresponding ticket to the support or fill out the appropriate form by clicking on the link",
        d:
          "The fee for each user who placed an ad for every deal is 0.4% of the total amount of the transaction. You can find information on all fees on the relevant page of our website.",
        e:
          "Once a trade is open you can not change the price, except when there is a clear mistake in the pricing.",
        f:
          "You are not allowed to buy or sell bitcoins on behalf of other persons (brokerage)",
        g:
          "You can only use payment accounts registered in your own name (payments from third parties are prohibited!)",
        i:
          "You must specify your payment details in the ad or trade chat. Payment details specified in the ad are available to counterparties, only after you confirm the request for an exchange",
        j: "All communication must happen on P2PAX.COM",
        u:
          'Payment methods marked as "High risk" involve a significant risk of fraud. Be cautious and always check the identity of your trade partners if you use a high-risk payment method',
      },
      hits: {
        a:
        ...
        b:
          "Now the trade price is determined from the hourly market price. For more information about equations how to determine your trading price see pricing FAQ. Please note that the advertiser is always responsible for all payment processing fees.",
        c:
          "The minimum price among all orders from other users on this exchange",
        d:
          "Profit Margin you want over the bitcoin market price. Use a negative value for buying or selling under the market price to attract more contacts. For more complex pricing edit the price equation directly.",
        e:
