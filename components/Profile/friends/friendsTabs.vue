<template>
  ...
  >
    <el-tab-pane label="Dashboard" name="Dashboard">
      <el-row class="custom-sidebar-top">
        ...
        <el-col
          ...
          :lg="12"
          :xl="12"
          class="dashboard-text-wrap"
        >
          <div class="title-reff fs24px fw600 mt30px mb20px">
            Refer a friend, earn up to 50% of commission and stand a chance to
            win prizes!
          </div>
          <div class="partner-text fs14px color-text-secondary">
            Invite your friends via social media or email and track performance
            - number of invitations, clicks, sign ups, referral network and
            overall performance.
          </div>
    ...
    <el-tab-pane label="My referrals" name="My referrals">
      <el-row class="referrals-input-wrap mb0px pt10px">
        ...
        >
          <el-date-picker v-model="value2" type="date" placeholder="From">
          </el-date-picker>
          <el-date-picker v-model="value2" type="date" placeholder="To">
          </el-date-picker>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="number" width="40" align="left" label="№">
        </el-table-column>
        <el-table-column
          prop="date"
          width="110"
    ...
    <el-tab-pane label="How it works" name="How it works"
      >How it works</el-tab-pane
    >
    <el-tab-pane label="Competition" name="Competition"
      >Competition</el-tab-pane
    >
  </el-tabs>
</template>
